...
public class ProductMasterDaoImpl implements ProductMasterDao {
	...
	public static final String INS_ITEM_QRY = "INSERT INTO coronaHealthPackage(id,productdesc,productname,cost) values(?,?,?,?)";
	public static final String UPD_ITEM_QRY = "UPDATE coronaHealthPackage SET productdesc=?,productname=?,cost=? WHERE id=?";
	public static final String DEL_ITEM_QRY = "DELETE FROM coronaHealthPackage WHERE id=?";
	public static final String SEL_ITEM_QRY_BY_ID = "SELECT id,productdesc,productname,cost FROM coronaHealthPackage WHERE id=?";
	public static final String SEL_ALL_ITEMS_QRY = "SELECT id,productdesc,productname,cost FROM coronaHealthPackage";
